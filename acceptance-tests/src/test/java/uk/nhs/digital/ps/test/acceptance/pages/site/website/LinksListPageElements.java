...
import static uk.nhs.digital.ps.test.acceptance.pages.site.website.LinksListPageElements.FieldKeys.*;
...
public class LinksListPageElements implements PageElements {
    ...
    private static String getDataUiPathXpath(String fieldName) {
        return "@data-uipath='website.linkslist." + fieldName + "'";
    }
