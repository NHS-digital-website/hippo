...
Then('I should see {string} results when search text is {string}:', async function (this: CustomWorld, resultsNum: string, searchText: string, recordResult: DataTable) {
