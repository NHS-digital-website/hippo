...
public class HeadingsHyperlinksFromMarkdownHelperTest {
    ...
    public void rendersMainBlockForTopTwoLevelsOfHeadings(
    ...
    public static Object[][] headingsInRangeOfAtxCompliantFormats() {
        ...
        return new Object[][]{
            ...
            {"headings starting with level 1",                  asList( 1,  2,  3),               asList( 1,  2),        },
            {"headings at the end of the normal 1-6 range",     asList( 4,  5,  6),               asList( 4,  5),        },
            {"headings outside of the normal 1-6 range",        asList(10, 11, 12),               asList(10, 11),        },
            {"headings in ascending order",                     asList( 1,  2,  3),               asList( 1,  2),        },
            {"headings in descending order",                    asList( 3,  2,  1),               asList( 2,  1),        },
            {"headings with top level heading in the middle",   asList( 4,  3,  5),               asList( 4,  3),        },
            {"headings that are non-consecutive",               asList( 2,  4,  5),               asList( 2),            },
            {"multiple headings of the same level",             asList( 2,  3,  4, 2, 3, 4, 5),   asList( 2,  3, 2, 3),  },
            {"complex mix of headings",                         asList( 5,  2,  4, 3, 6, 2, 4),   asList( 2,  3, 2),     }
        };
        // @formatter:on
    }
    ...
    @Test
    public void throwsException_onRenderingFailure() throws IOException {
