...
This project's development environment is designed to run on Ubuntu. For Windows users, you must use Windows Subsystem for Linux 2 (WSL 2) with Ubuntu. This is a team requirement and other development environments are not supported.
