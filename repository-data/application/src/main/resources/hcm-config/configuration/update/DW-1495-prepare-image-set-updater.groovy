...
class PrepareImageSetUpdater extends BaseNodeUpdateVisitor {
    ...
    public static final String NEW_FOLDER = "new-website-corporateWebsiteImageset-folder"
    public static final String NEW_IMAGE = "website:corporateWebsiteImageset"
