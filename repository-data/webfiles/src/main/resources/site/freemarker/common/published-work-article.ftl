...
<dl class="detail-list">
    ...
    <dd class="detail-list__value" data-uipath="ps.dataset.nominal-date" itemprop="datePublished">
        <@fmt.formatDate value=document.publicationDate.time?date type="date" pattern="yyyy-MM-dd" timeZone="${getTimeZone()}" />
    </dd>
</dl>
</#macro>
        ...
        <div class="local-header article-header article-header--detailed">
            <div class="grid-wrapper">
                <div class="article-header__inner">
                    ...
                    <#-- TODO - These are not populated in the CMS just yet -->
