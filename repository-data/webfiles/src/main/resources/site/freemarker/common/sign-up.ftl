...
<#-- @ftlvariable name="document" type="uk.nhs.digital.website.beans.Signup" -->
<#-- @ftlvariable name="form" type="com.onehippo.cms7.eforms.hst.beans.FormBean" -->
...
<@documentHeader document 'sign-up'></@documentHeader>
...
<#--<#include "eforms/eforms-head-contributions.ftl"/>-->

<#--<#include "eforms/eforms.js.ftl"/>-->
