    ...
    <#if socialmedia??>
        <#list socialmedia as socialmediaItem>
            ...
            <#if linkIcon?has_content>
                <div class="nhsd-t-row">
                    <div class="nhsd-t-col-12">
                        <a class="nhsd-a-icon-link nhsd-a-icon-link--dark-grey" href="${socialmediaItem.nhsDigitalUrl}" target="_blank" rel="external" onClick="logGoogleAnalyticsEvent('Link click','Social media - ${socialmediaItem.linkName}','${socialmediaItem.nhsDigitalUrl}');">
