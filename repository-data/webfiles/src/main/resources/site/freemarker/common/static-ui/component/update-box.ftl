...
<div class="update-box update-box--important" role="complementary" aria-labelledby="update-box-title-important">
    <div class="update-box__heading">
        <svg class="update-box__heading-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 217.07 187.02" preserveAspectRatio="xMidYMid meet" role="presentation" focusable="false">
        ...
        <h2 class="update-box__heading-title" id="update-box-title-important">Update box (important)</h2>
    </div>
...
<div class="update-box update-box--critical" role="complementary" aria-labelledby="update-box-title-critical">
    <div class="update-box__heading">
        <svg class="update-box__heading-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215.92 186.68" preserveAspectRatio="xMidYMid meet" role="presentation" focusable="false">
        ...
        <h2 class="update-box__heading-title" id="update-box-title-critical">Update box (critical)</h2>
    </div>
