...
<div class="update-box update-box--information">
    <div class="update-box__heading">
        ...
        <h2 class="update-box__heading-title">Update box (information)</h2>
    </div>
...
<div class="update-box update-box--important">
    <div class="update-box__heading">
        ...
        <h2 class="update-box__heading-title">Update box (important)</h2>
    </div>
...
<div class="update-box update-box--critical">
    <div class="update-box__heading">
        ...
        <h2 class="update-box__heading-title">Update box (critical)</h2>
    </div>
