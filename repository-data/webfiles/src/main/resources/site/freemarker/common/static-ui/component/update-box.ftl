...
<div class="update-box update-box--information" role="complementary" aria-labelledby="update-box-heading-information">
    ...
    <div class="update-box__content">
        <h2 class="update-box__content-heading" id="update-box-heading-information">Update box (information)</h2>
...
<div class="update-box update-box--important" role="complementary" aria-labelledby="update-box-heading-important">
    <div class="update-box__content">
    ...
    <div class="update-box__content">
      <h2 class="update-box__content-heading" id="update-box-heading-important">Update box (important)</h2>
...
<div class="update-box update-box--critical" role="complementary" aria-labelledby="update-box-heading-critical">
    <div class="update-box__icon-wrapper">
    ...
    <div class="update-box__content">
        <h2 class="update-box__content-heading" id="update-box-heading-critical">Update box (critical)</h2>
