...
<div class="grid-row">
    <div class="column column--one-third column--left">
        <nav class="menu">
            <ul class="list list--reset">
                ...
                <li><a href="#">Our leadership and governance</a></li>
                <li><a href="#">Technology suppliers</a></li>
    ...
    <div class="column column--one-third column--center">
        ...
        <a href="#" class="button">View all news</a>
    </div>

    <div class="column column--one-third column--right">
        <div class="cta-list">
            <h3 class="list-title">Upcoming events</h3>
            <ol class="list--reset cta-list">
                <li>
                    <article class="cta">
