                    ...
                    <div class="grid-row">
                        <div class="column column--two-thirds column--reset">
                            <div class="list list--reset cta-list cta-list--sections">
                                ...
                                <div class="cta">  
                                    <h2 class="cta__title"><a href="#">Calculating Quality Reporting Service</a></h2>
                                    <p class="cta__text">The Calculating Quality Reporting Service (CQRS) is an approvals, reporting and payments calculation system for GP practices.</p>
                                </div>
                                <div class="cta">  
                                    <h2 class="cta__title"><a href="#">Cancer Screening Programme National Statistics</a></h2>
                                    <p class="cta__text">Aggregated statistical data are collected from primary care organisations' NHAIS systems and used to assist the running of the screening programmes.</p>
                                </div>
                                <div class="cta">  
                                    <h2 class="cta__title"><a href="#">CareCERT (Cyber Security Programme)</a></h2>
                                    <p class="cta__text">CareCERT offers advice and guidance to help health and social care organisations respond effectively and safely to cyber security threats.</p>
                                </div>
                                <div class="cta">  
                                    <h2 class="cta__title"><a href="#">Child Protection - Information Sharing project</a></h2>
                                    <p class="cta__text">The Child Protection - Information Sharing project (CP-IS) is helping health and social care staff to share information securely to better protect society's most vulnerable children.</p>
                                </div>
                            </div>
                        </div>
                    </div>
