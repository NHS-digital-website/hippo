        ...
        <#if pageCount gt 1>
            <#list pageNumbers as pageNr>
                <@hst.renderURL var="pageUrl">
                    ...
                    <@hst.param name="pageSize" value="${cparam.pageSize}"/>
                </@hst.renderURL>
                ...
                <#if pageNr_index==0>
                    <#if pageable.previous>
                        ...
                        <li class="pagination-list__item pagination-list__item--first">
                            <#outputformat "undefined"><a
                                href="${pageUrlFirst}" title="First"><span
                                        class="next">First</span>
                                </a></#outputformat>
                        </li>
                        ...
                        <li class="pagination-list__item pagination-list__item--previous">
                            <#outputformat "undefined"><a
                                href="${pageUrlPrevious}" title="Previous">
                ...
                <#if pageable.currentPage == pageNr>
                    <li class="pagination-list__item pagination-list__item--current">
                        <span class="">${pageNr}</span></li>
                <#else >
                    <li class="pagination-list__item">
                        <#outputformat "undefined"><a href="${pageUrl}"
                                                      title="Page ${pageNr}">${pageNr}</a></#outputformat>
                    </li>
                </#if>
                <#if !pageNr_has_next>
                    <#if pageable.next>
                        ...
                        <li class="pagination-list__item pagination-list__item--next">
                            <#outputformat "undefined"><a
                                href="${pageUrlNext}" title="Next"><span
