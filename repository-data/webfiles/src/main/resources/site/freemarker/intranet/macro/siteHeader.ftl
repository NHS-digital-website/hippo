                                ...
                                <div class="nhsd-m-search-bar">
                                    <form role="search" method="get" action="${searchLink}" class="nhsd-t-form" novalidate autocomplete="off" aria-label="Search">
                                        <div class="nhsd-t-form-group">
                                            <div class="nhsd-o-dropdown nhsd-o-dropdown--full-width" id="globalSearchDropdown" data-live-search-url="<@hst.link siteMapItemRefId="search-json" />" data-search-url="${searchLink}" style="--dropdown-height: 360px">
