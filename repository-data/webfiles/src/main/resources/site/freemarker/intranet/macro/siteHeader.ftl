                ...
                <div class="nhsd-t-col">
                    <div class="nhsd-o-global-header__content-box">
                        ...
                        <nav class="nhsd-m-button-nav nhsd-m-button-nav--condensed nhsd-m-button-nav--non-responsive nhsd-o-global-header__button-nav">
                            ...
                            <a class="nhsd-a-button nhsd-a-button--circle" id="nhsd-global-header__search-button" aria-label="Open search" aria-controls="nhsd-global-header__search" aria-expanded="false" href="<@hst.link siteMapItemRefId="search" />">
                                <span class="nhsd-a-icon nhsd-a-icon--size-s">
                                    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true" focusable="false" viewBox="0 0 16 16"  width="100%" height="100%">
                                ...
                                <div class="nhsd-m-search-bar">
                                    <form role="search" method="get" action="${searchLink}" class="nhsd-t-form" novalidate autocomplete="off" aria-label="Search">
                                        <div class="nhsd-t-form-group">
                                            <div class="nhsd-o-dropdown nhsd-o-dropdown--full-width" id="heroSearchDropdown" data-live-search-url="<@hst.link siteMapItemRefId="search-json" />" data-search-url="${searchLink}" style="--dropdown-height: 350px">
                                                ...
                                                <div class="nhsd-o-dropdown__dropdown">
                                                    <ul role="listbox" id="heroSearchDropdown"></ul>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
