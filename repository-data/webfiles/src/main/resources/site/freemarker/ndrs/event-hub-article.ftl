...
<#include "../common/macro/stickyNavYears.ftl">
<#include "../common/macro/stickyNavTags.ftl">
<#include "../common/macro/hubBox.ftl">
<#include "../common/macro/stickyGroupBlockHeader.ftl">
