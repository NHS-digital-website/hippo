...
<@hst.setBundle basename="month-names,ndrs-facet-headers,facet-labels, doctype-labels"/>
                                ...
                                <#else>
                                    <#list facetItems as value>
                                        ...
                                        <li class="${listItemClassName}">
                                            <#if value.leaf>
                                                ...
                                                <a href="${link}"
                                                   title="${valueName}"
                                                   class="filter-link filter-link--active">${valueName}
                                                </a>
                                            <#else>
                                    ...
                                    <#if facetItems?size &gt; facetMaxCount >
                                        <li class="filter-vis-toggles">
                                            ...
                                            <a href="#" class=" filter-vis-toggle filter-vis-toggle--hide is-hidden">Show less</a>
                                        </li>
                                    </#if>
                                </#if>
                            </ul>
            ...
            <div class="filter-section__contents">
                <ul class="filter-list"
                    ...
                    <#if facetFields?size &gt; facetMaxCount >
                        <li class="filter-vis-toggles">
                            <a href="#" class="filter-vis-toggle filter-vis-toggle--show">Show all (${ facetFields?size})</a>
                            <a href="#" class=" filter-vis-toggle filter-vis-toggle--hide is-hidden">Show less</a>
                        </li>
                    </#if>
                </ul>
                        ...
                        <#list fields as field>
                            <#if field.name?? && field.name?has_content>
                                <li class="filter-list__item ${isSelected("topic", field.name)?then("filter-list__item--no-children", "")}">
                                    <a href="${field.facetUrl}" title="<@fmt.message key= facetLabel />"
