...
<#assign hasUniquePropertyRefrenceNumber = document.uniquePropertyReferenceNumber?? />
...
<article>
                ...
                <div class="article-header__inner">
                    <#if hasLocalAddress>
                        ...
                        <#if document.locAddress.buildinglocation?has_content >
                            <#assign localAddress += "<span itemprop=\"location\">${document.locAddress.buildinglocation}</span>,"/>
                        </#if>
                        <#assign localAddress +=  "<span itemprop=\"number\">${document.locAddress.buildingname}</span>"/>
                        <#if document.locAddress.street?has_content >
                            <#assign localAddress +=  "<span itemprop=\"street\">${document.locAddress.street}</span>"/>
                        </#if>
                        <#if document.locAddress.area?has_content>
                            <#assign localAddress +=", <span itemprop=\"area\">${document.locAddress.area}</span>"/>
                        </#if>
                        <#if document.locAddress.city?has_content>
                            <#assign localAddress +=", <span itemprop=\"city\">${document.locAddress.city}</span>"/>
                        </#if>
                        <#if document.locAddress.county?has_content>
                            <#assign localAddress +=", <span itemprop=\"county\">${document.locAddress.county}</span>"/>
                        </#if>
                        <#assign localAddress +=", <span itemprop=\"country\">${document.locAddress.country}</span>, <span itemprop=\"postcode\">${document.locAddress.postalCode}</span>"/>
                        <#if document.locAddress.mapLink?has_content>
                            <#assign localAddress += " <a href=\"${document.locAddress.mapLink}\"
                    ...
                    <#if document.emailaddress?has_content >
                        <#assign metadata += [{
                        "title": "Email address:",
                        "value": "<a href=\"mailto:${document.emailaddress}\"
                    ...
                    <#if document.threewordskey?has_content >
                        ...
                        "value": "<a href=https://what3words.com/${document.threewordskey}
                    ...
                    <#if document.pluscode?has_content >
                        <#assign metadata += [{
                        "title": "Plus codes location:",
                        "value": "<a href=\"https://plus.codes/${document.pluscode}\"
                                         title=\"Open pluscode link in new window\" target=\"_blank\"><span>${document.pluscode}</span>
                                     </a>"
                        }] />
                    </#if>
                    <#if hasGeocoordinates>
                        <#assign content = "${document.locAddress.geocoordinates.content}"/>
                        <#assign metadata += [{
                        "title": "Geocordinates:",
                        "value": "${content}"
                        }] />
                    ...
                    <#if document.locationWebsite?? && document.locationWebsite.link?has_content >
                        ...
                        "value": "<a href=\"${document.locationWebsite.link}\"
    ...
    <#assign heroOptions += {
    "title":"${document.name}",
    "introText":"${document.description}",
    "metaData": metadata
    }/>
    <@hero heroOptions />
            ...
            <div class="nhsd-t-col-xs-12 nhsd-t-col-s-8">
                    ...
                    <div class="article-section">
                        <div id="Theoffice"
                            ...
                            <div class="emphasis-box emphasis-box-important">
                                <div data-uipath="website.contentblock.urgentinformation"
                                     class="emphasis-box__content">
                ...
                <#if hasImageOfSite >
                    <div class="rich-text-content">
                        ...
                        <img src="${iconImage}"
                             alt="${document.imageOfSiteAltText}"/>
                    </div>
                </#if>
                <#if hasOpeningHours>
                    <div class="article-section">
                        <div id="Openinghours"
                             class="article-section article-section--highlighted">
                            <h2 data-uipath="website.contentblock.openinghours.title">
                                Opening hours</h2>
                ...
                <#if hasDirectionToSiteByPublicTransports>
                    <#list document.directionToSiteByPublicTransportation as dirToSiteByPublicTrans >
                        <div class="article-section">
                            <div id="${dirToSiteByPublicTrans.publictransportType?lower_case}"
                                 class=" article-section article-section--highlighted">
                                <h2 data-uipath="website.contentblock.publictransport.title">
                                    Directions
                                    by ${dirToSiteByPublicTrans.publictransportType?lower_case}</h2>
                                <div data-uipath="website.contentblock.bypublictransporttext"
                                ...
                                <#list dirToSiteByPublicTrans.publicTransportStations as publictransportstation >
                                    <div>
                                        <#if publictransportstation.name?has_content >
                                            <span class="station-name">${publictransportstation.name}</span></#if><#if publictransportstation.distance?has_content >
                                        <span class="distance"> (${publictransportstation.distance})</span>
                                        <h3></#if>
                                    </div>
                                    <div>
                                        ...
                                        <#if hasWalkingTime>
                                            <span>${publictransportstation.walkingtime}
                                            walking</span></#if><#if hasWalkingTime && hasDrivingTime>, </#if><#if hasDrivingTime>
                                            <span>${publictransportstation.drivingtime}
                                            driving</span></#if>
                                    </div>
                                    ...
                                    <#if publictransportstation.byPublicTransportPicture?has_content>
                                        <div class="rich-text-content">
                                            ...
                                            <img src="${iconImagePubTrans}"
                                                 alt="${publictransportstation.byPublicTransportPictureAltText}"/>
                                        </div>
                                    </#if>
                                    <#if publictransportstation.byPublicTransportVideo?has_content>
                                        <div data-uipath="website.contentblock.publictransport.video"
                                             class="rich-text-content">
                ...
                <#if hasLocalTaxis>
                    <div class="article-section">
                        <div id="taxi"
                             class=" article-section article-section--highlighted">
                            <h2 data-uipath="website.contentblock.taxi.title">
                                Taxi</h2>
                ...
                <#if hasDirectionToSiteByCar >
                    <div class="article-section">
                        <div id="directionsbycar"
                             class=" article-section article-section--highlighted">
                            <h2 data-uipath="website.contentblock.directiontositebycars.title">
                                Directions by car</h2>
                            <div>
                                <#if document.directiontositebycars.bycartext?? && document.directiontositebycars.bycartext.content?has_content>
                                    <div data-uipath="website.directiontositebycars.bycartext"
                                         class="rich-text-content">
                                ...
                                <#if document.directiontositebycars.bycarpicture?has_content>
                                    <div class="rich-text-content">
                                        ...
                                        <img src="${iconImagecarpark}"
                                             alt="${document.directiontositebycars.byCarPictureAltText}"/>
                                    </div>
                                </#if>
                ...
                <#if hasOnsiteCarsParking>
                    <div class="article-section">
                        <div id="carparking"
                             class=" article-section article-section--highlighted">
                            <h2 data-uipath="website.contentblock.theoffice.title">
                                Car parking</h2>
                            <#if document.onsitecarsparking.name?has_content >
                                ...
                                <a href="${hrefValue}"
                                   title="Open car parking website in new window"
                                   target="_blank"><span class="station-name"
                                                         itemprop="location">${document.onsitecarsparking.name}</span>
                                </a>
                            </#if>
                            <#if document.onsitecarsparking.distancefromsite?has_content>
                                &nbsp;<span
                                    class="distance">(${document.onsitecarsparking.distancefromsite})</span>
                            </#if>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span class="car-label">Geocordinates: </span><span
                                                class="car-geocoordinates"><@hst.html hippohtml=document.onsitecarsparking.geocoordinates contentRewriter=gaContentRewriter/>
                                    </div>
                                </div>
                            </div>
                            </#if>
                ...
                <#if hasCyclesParking>
                    <div class="article-section">
                        <div id="cycleparking"
                             class=" article-section article-section--highlighted">
                            <h2 data-uipath="website.contentblock.cycleparking.title">
                                Cycle parking</h2>
                ...
                <#if hasOtherLocationData>
                    <div class="article-section">
                        <div id="otherlocationdata"
                             class=" article-section article-section--highlighted">
                            <h2 data-uipath="website.contentblock.theoffice.title">
                                Other location data</h2>
