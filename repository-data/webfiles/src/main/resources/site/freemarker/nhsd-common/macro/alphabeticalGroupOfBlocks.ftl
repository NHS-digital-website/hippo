                    ...
                    <div class="cta">
                        <#if block.linkType??>
                            ...
                            <#elseif block.linkType == "asset">
                                <h2 class="cta__title"><a href="<@hst.link hippobean=block.link />" onKeyUp="return vjsu.onKeyUp(event)">${block.title}</a><@fileMetaAppendix block.link.asset.getLength()></@fileMetaAppendix></h2>
                            </#if>
                        <#else>
                            <@typeSpan "internal" />
