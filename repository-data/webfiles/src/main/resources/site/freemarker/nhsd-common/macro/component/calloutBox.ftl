...
<#macro calloutBox callout>
    ...
    <#elseif severity == 'emphasis'>
        <#assign borderColour = 'blue' />
    </#if>

    <div class="nhsd-m-emphasis-box nhsd-m-emphasis-box--${severity} nhsd-!t-margin-bottom-6" role="complementary" aria-labelledby="callout-box-heading-${calloutBoxId}">
