...
<#macro furtherInformationSection childPages prompt=false>
                ...
                <#if childPage.linkType??>
                    ...
                    <#if childPage.linkType == "asset">
                        <div class="nhsd-t-col-12 nhsd-!t-no-gutters nhsd-!t-margin-bottom-6">
                            <@downloadBlockAsset document.class.name childPage.link "${childPage.title}" "" childPage.link.asset.mimeType childPage.link.asset.getLength() false false prompt/>
                        </div>
                    </#if>
                </#if>
            </div>
