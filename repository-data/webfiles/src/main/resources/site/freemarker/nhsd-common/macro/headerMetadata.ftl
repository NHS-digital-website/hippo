                ...
                <div class="nhsd-o-hero__meta-data-item-description" ${uipath}>
                    <#if data.type?? >
                        ...
                        <#elseif data.type == "link" >
                            <a class="nhsd-a-link nhsd-a-link--col-white" href="<@hst.link hippobean=data.value/>" onKeyUp="return vjsu.onKeyUp(event)"><span ${itempropProp}>${data.value.title}</span></a>
