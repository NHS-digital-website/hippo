...
<#macro checklist section>
    ...
    <div class="nhsd-m-checklist nhsd-!t-margin-bottom-6">
        <#if section.heading?has_content>
            <span
                class="nhsd-t-heading-s nhsd-!t-col-white nhsd-m-checklist__header"
                data-uipath="website.contentblock.checklist.heading">${section.heading}</span>
        </#if>

        <div
            class="nhsd-m-checklist__list-container <#if !section.heading?has_content>nhsd-m-checklist__list-container--no-heading</#if>">
                ...
                <#list section.listentries as entry>
                    ...
                    <span class="nhsd-m-checklist__icon" style="vertical-align:text-top;">
                            <#if section.icon?trim == 'Tick'>
                                <span
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         ...
                                         height="100%">
                                        <path
                                            d="M16,3.5L5.5,14L0,8.5L1.5,7l4,4l9-9L16,3.5z"/>
                                    </svg>
                                </span>
                            <#elseif section.icon?trim == 'Cross'>
                                ...
                                <@hst.link hippobean=section.customicon.original fullyQualified=true var="leadImage" />
                                    <span class="nhsd-a-icon nhsd-a-icon--size-xs">
                                        <#if leadImage?ends_with("svg")>
                                            <img
                                                src="data:image/svg+xml;base64,${base64(colour(section.svgXmlFromRepository, "005eb8"))}"
                                                alt="Custom image"/>
                                        <#else>
                               ...
                               <#else>
                                <span
                                    class="nhsd-a-icon nhsd-a-icon--size-xs nhsd-a-icon--col-black">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             preserveAspectRatio="xMidYMid meet"
                                             aria-hidden="true"
                                             focusable="false"
