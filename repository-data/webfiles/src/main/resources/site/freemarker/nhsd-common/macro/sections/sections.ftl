...
<#macro sections sections mainHeadingLevel=2 wrap=false padSections=false prompt=false>
    ...
    <#list sections as section>
        ...
        <div >
            ...
            <#elseif section.sectionType == 'gallerySection'>
                <@gallerySection section=section mainHeadingLevel=mainHeadingLevel prompt=prompt/>
            ...
            <#elseif section.sectionType == 'download'>
                <@downloadSection section=section mainHeadingLevel=mainHeadingLevel prompt=prompt/>
