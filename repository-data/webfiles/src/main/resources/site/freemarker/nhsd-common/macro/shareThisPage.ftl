...
<#macro shareThisPage document mediaTitle="" mediaLink="" iconPath="" smOptions={}>
<#assign divStyle = (!smOptions?has_content || (smOptions?has_content && smOptions.horizontal))?then("style='float:left;'", "class='nhsd-t-row'")/>
<#assign iconSize = (!smOptions?has_content || (smOptions?has_content && smOptions.large))?then("nhsd-a-icon--size-xxl", "nhsd-a-icon--size-l")/>
