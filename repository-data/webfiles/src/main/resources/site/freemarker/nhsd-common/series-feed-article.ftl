...
<#include "../publicationsystem/macro/seriesDocumentHeader.ftl">
...
<#-- Add meta tags -->
<@metaTags></@metaTags>
<@hst.setBundle basename="rb.doctype.seriesfeed,rb.generic.headers,publicationsystem.headers,publicationsystem.labels,emails"/>
...
<#assign hasSummarySection = document.summary?? && document.summary?has_content />
<#assign hasLatestStatisticsSection = document.latestPublication?? && document.latestPublication?has_content />
<#assign hasAboutSection = document.about?? && document.about.content?has_content />
<#assign hasMethodologySection = document.methodology?? && document.methodology.content?has_content />
...
<#assign hasResponsibleStatistician = document.statistician?? && document.statistician?has_content />
<#assign hasResponsibleTeam = document.team?? && document.team?has_content />
<#assign hasResourceLinks = document.resourceLinks?? && document.resourceLinks?has_content />
<#assign hasAttachments = document.attachments?? && document.attachments?has_content />
...
<#assign hasPreReleaseAccessSection = document.releaseSubjects?? && document.releaseSubjects?has_content />
<#assign hasMetadataSection = (document.issn?? && document.issn?has_content) || (document.refNumber?? && document.refNumber?has_content) />
