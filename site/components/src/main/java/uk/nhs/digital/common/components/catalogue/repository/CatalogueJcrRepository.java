...
public class CatalogueJcrRepository implements CatalogueRepository {

    private static final Logger log = LoggerFactory.getLogger(CatalogueJcrRepository.class);

    private final String taxonomyFiltersMappingDocumentPath;
    private final Session session;

    public CatalogueJcrRepository(final Session session, final String taxonomyFiltersMappingDocumentPath) {
    ...
    public Optional<String> taxonomyFiltersMapping() {
        ...
        try {
            ...
            if (mappingDocumentHandle == null) {
                log.warn("Catalogue's taxonomy-filters mapping document not found at {}", taxonomyFiltersMappingDocumentPath);
