...
public class BloomreachSearchProvider {
    ...
    public Pageable<HippoBean> getBloomreachResults(String queryString, int pageSize, int currentPage,
            List<SearchArea> searchAreas, List<Team> teams, List<String> years, List<String> taxonomies, String sort) {
    ...
    public int getBloomreachResultsCount(String queryString, List<SearchArea> searchAreas,
            List<Team> teams, List<String> years, List<String> taxonomies) {
        HstQuery query = getQuery(queryString, searchAreas, teams, years, taxonomies, null);
        query.setLimit(0);
        try {
            final HstQueryResult execute = query.execute();
    ...
    private HstQuery getQuery(String queryString, List<SearchArea> searchAreas,
        ...
        if (searchAreas != null && searchAreas.contains(SearchArea.NEWS)) {
            constraintList.add(
                or(
        ...
        List<Class> docTypesClass = SearchArea.getDocTypesFromSearchAreas(searchAreas);
