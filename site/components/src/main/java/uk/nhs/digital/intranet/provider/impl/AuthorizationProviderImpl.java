...
public class AuthorizationProviderImpl implements AuthorizationProvider {
    ...
    public AuthorizationProviderImpl(final RestTemplate restTemplate, final String applicationId, final String redirectUri, final String clientSecret, final String baseUri) {
