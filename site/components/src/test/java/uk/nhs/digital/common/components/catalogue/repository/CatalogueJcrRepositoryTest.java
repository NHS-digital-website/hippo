...
public class CatalogueJcrRepositoryTest {
    ...
    public void taxonomyFiltersMapping_returnsConfigurationInYaml_whenAvailable() throws IOException, RepositoryException {
        ...
        final CatalogueJcrRepository catalogueJcrRepository = new CatalogueJcrRepository(session, taxonomyPath);

        // when
        final String actualTaxonomyFiltersMappingYaml =
            catalogueJcrRepository.taxonomyFiltersMapping().orElse("nothing was returned");
    ...
    public void taxonomyFiltersMapping_returnsEmpty_whenMappingDocumentNotAvailable() throws RepositoryException {
        ...
        final CatalogueJcrRepository catalogueJcrRepository =
            new CatalogueJcrRepository(
                session,
                "/content/documents/administration/website/developer-hub/taxonomy-filters-mapping"
            );

        // when
        final Optional<String> actualTaxonomyFiltersMappingYaml = catalogueJcrRepository.taxonomyFiltersMapping();
