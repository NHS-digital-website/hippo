...
import uk.nhs.digital.intranet.provider.impl.AuthorizationProviderImpl;
...
public class AuthorizationProviderImplTest {
    ...
    @Before
    public void setUp() {
        authorizationProvider = new AuthorizationProviderImpl(restTemplate, APP_ID, REDIRECT_URI, CLIENT_SECRET, BASE_URI);
    }
    ...
    public void callsGraphApiWithCorrectHeadersAndReturnsAccessToken() throws Exception {
        ...
        map.add("scope", "https://graph.microsoft.com/user.read.all");
