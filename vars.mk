...
PROXYGEN_CLIENT_SECRET ?= REPLACE_WITH_ACTUAL_PROXYGEN_CLIENT_SECRET
...
MVN_VARS = -Dexternalstorage.aws.bucket=$(S3_BUCKET) \
    ...
    "-Ddevzone.apispec.sync.daily-cron-expression=$(API_SPEC_SYNC_CRON)" \
...
export DEVZONE_PROXYGEN_OAUTH_USERNAME=$(PROXYGEN_USER)
export DEVZONE_PROXYGEN_OAUTH_PASSWORD=$(PROXYGEN_PASS)
export DEVZONE_PROXYGEN_OAUTH_CLIENT_ID=$(PROXYGEN_CLIENT_ID)
export DEVZONE_PROXYGEN_OAUTH_CLIENT_SECRET=$(PROXYGEN_CLIENT_SECRET)